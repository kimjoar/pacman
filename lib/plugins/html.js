...
/*
 * Decide if an HTML file needs processing, i.e.
 * the content has tags, and the file is not ignored.
 */
var needsProcessing = function(f, data) {
  var not_ignored = config.needsProcessing(f);
...
module.exports = function(f, data, locals) {
  ...
  return partial ? data : processLayout(f, data);
};
