...
exports.watch = function() {
  log("Watching", fss.baseRelative(config.appdir));
  watch.createMonitor(config.appdir, { persistent: true, interval: config.interval }, function (monitor) {
...
exports.regenAll = function() {
  ...
  fss.all(config.appdir, function(files) {
    ...
    log("Generating", fss.baseRelative(dir));
